...
<div>
    <section>
        <div class="wrap2">
            ...
            <div class="goodsBox">
                <ul class="goods_detail" data-type='+i.productType+' data-sku='+i.skuNumber+' data-count='+i.productCount+' data-cartId='+i.cartId+' >
                <li class="goods_img" >
                <img src="'+i.img+'" alt="">
                </li>
                <li class="goods_info">
    ...
    <footer>
        <ul class="footer">
            <li>
                ...
                <input type="checkbox" class="check_select" id="selectAll">
            全选(<span class="shopNum">0</span>)
            </li>
            <li class="all_price">
