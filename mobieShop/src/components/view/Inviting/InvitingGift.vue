...
<script>
    ...
    export default {
        data() {
            return {
                ...
                dataInfo: [{
                    ...
                    {
                        id: 1,
                        data: 'recommendedCustomerId',
                        des: '推荐来源客户id'
                    },
                    {
                        id: 2,
                        data: 'recommendedAdminId',
                        des: '推荐来源后台用户id'
                    },
                    {
                        id: 3,
                        data: 'recommendedDepartmentId',
                        des: '推荐来源部门id'
                    },
                    {
                        id: 4,
                        data: 'recommendedSourceId',
                        des: '推荐来源种类'
                    },
                ],
                formData: {
        ...
        methods: {
            ...
            sendMessage() {
                let that = this
                this.$http.post('/api/customer/resource/sendSmsCode?mobile=' + that.formData.phone + '&type=1').then(function(response) {
                    Toast({
